...
oneJQuery(function ($) {
    ...
    json.afterAction = function () {
        ...
        oneJQuery('#slidesjs-0B3B569C-86AB-4598-8753-5F8E6179B6C4 .slider-caption').each(function () {
            var el = oneJQuery(this);
            el.width(el.parent().width() - 10);
        });
        oneJQuery('#slidesjs-0B3B569C-86AB-4598-8753-5F8E6179B6C4 .slide-cntnr.middle p.slider-caption').each(function () {
            var el = oneJQuery(this);
            el.height(el.find('span').height());
        });
    };
    var $slidejs = $('#slidesjs-0B3B569C-86AB-4598-8753-5F8E6179B6C4');
    if ($slidejs.children().length) {
        var carousel = $slidejs.owlCarousel(json);
        carousel.data('owlCarousel').updateVars();
        var resetHeight = function () {
            if (window.innerWidth < 650) {
                var ratio = 0.3669527896995708;
                if ($('#slidesjs-0B3B569C-86AB-4598-8753-5F8E6179B6C4').parents('.textblock').length) {
                    ratio = ratio / 2;
                }
                $('#slidesjs-0B3B569C-86AB-4598-8753-5F8E6179B6C4').height((window.innerWidth - 40) * ratio);
                $('#slidesjs-0B3B569C-86AB-4598-8753-5F8E6179B6C4 .slider-item').height((window.innerWidth - 40) * ratio);
                $('#slidesjs-0B3B569C-86AB-4598-8753-5F8E6179B6C4 .slider-caption').parent().height((window.innerWidth - 40) * ratio);
            }
        };
...
(function () {
    oneJQuery(function () {
        ...
        new window.OnewebContactForm({
            'formDOMId': 'E67C888D-6488-45D9-BF48-F312C9E05180',
            'postURL': '/____formmail/1/',
            'recipientEmail': 'admin%40sumikshaservices.com',
            'subject': 'New%20message%20via%20contact%20form%20on%20sumikshaservices.com%20-%20Home%20page',
