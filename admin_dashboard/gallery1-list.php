...
<?php 
    ...
    if(isset($_REQUEST['delete']))
    {
        ...
        $delete = "delete from gallery1 where id='$id'";
        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <a href="gallery1.php" class="btn btn-success"><i class="fa fa-plus"></i> add</a>
                </div>
                <div class="ibox-content">
					<div class="table-responsive">
	                    <table class="table table-striped table-bordered table-hover dataTables-example" >
		                    ...
		                    <tbody>
								<?php 
									$sql_cmp=$conn->query("select gallery1.*, gallery.name as gallery_name, gallery.id as gallery_id from gallery1 left join gallery on gallery.id = gallery1.gallery_id");
									$count=1;
			                    ...
			                    <tr class="gradeX">
			                        ...
			                        <td><?php echo $data_cmp['gallery_name']; ?></td>
			                        <td><?php echo $data_cmp['name']; ?></td>

			                        <td><img src="uploads/gallery/<?php echo $data_cmp['image']; ?>" style="width:100px;height:70px;"></td>

									<td class="center">
			                        	<a href="gallery1_edit.php?id=<?php echo $data_cmp['id']; ?>" class="btn btn-primary btn-circle">
