                        ...
                        <div class="col-md-4">
                            <div class="form-cont">
                                ...
                                <?php
                                    ...
                                    {
                                ?>
                                <a href="<?= base_url();?>admin_dashboard/uploads/pan_card_img/<?= $data1['pan_card_img'];?>" class="fresco" data-fresco-group="example">
                        ...
                        <div class="col-md-4">
                            <div class="form-cont">
                                ...
                                <?php
                                    ...
                                    {
                                ?>
                                <a href="<?= base_url();?>admin_dashboard/uploads/aadhar_card_img/<?= $data1['aadhar_card_img'];?>" class="fresco" data-fresco-group="example">
                        ...
                        <div class="col-md-4">
                            <div class="form-cont">
                                ...
                                <?php
                                    ...
                                    {
                                ?>
                                <a href="<?= base_url();?>admin_dashboard/uploads/bank_statement_img/<?= $data1['bank_statement_img'];?>" target="_blank">VIEW PDF</a>
                                <?php
                                    }
                                    else
                                    {
                                ?>
                                <a href="<?= base_url();?>admin_dashboard/uploads/bank_statement_img/<?= $data1['bank_statement_img'];?>" class="fresco" data-fresco-group="example">
                                    <img src="<?= base_url();?>admin_dashboard/uploads/bank_statement_img/<?= $data1['bank_statement_img'];?>" class="img-responsive">
                                </a>
                                <?php
                                    }
                                ?>
                        ...
                        <div class="col-md-4">
                            <div class="form-cont">
                                ...
                                <?php
                                    ...
                                    {
                                ?>
                                <a href="<?= base_url();?>admin_dashboard/uploads/property_site_map_img/<?= $data1['property_site_map_img'];?>" target="_blank">VIEW PDF</a>
                                <?php
                                    }
                                    else
                                    {
                                ?>
                                <a href="<?= base_url();?>admin_dashboard/uploads/property_site_map_img/<?= $data1['property_site_map_img'];?>" class="fresco" data-fresco-group="example">
                                    <img src="<?= base_url();?>admin_dashboard/uploads/property_site_map_img/<?= $data1['property_site_map_img'];?>" class="img-responsive">
                                </a>
                                <?php
                                    }
                                ?>
                        ...
                        <div class="col-md-4 salarry_slip" style="display: none;">
                            <div class="form-cont">
                                ...
                                <?php
                                    ...
                                    {
                                ?>
                                <a href="<?= base_url();?>admin_dashboard/uploads/salary_slip_img/<?= $data1['salary_slip_img'];?>" target="_blank">VIEW PDF</a>
                                <?php
                                    }
                                    else
                                    {
                                ?>
                                <a href="<?= base_url();?>admin_dashboard/uploads/salary_slip_img/<?= $data1['salary_slip_img'];?>" class="fresco" data-fresco-group="example">
                                    <img src="<?= base_url();?>admin_dashboard/uploads/salary_slip_img/<?= $data1['salary_slip_img'];?>" class="img-responsive">
                                </a>
                                <?php
                                    }
                                ?>
                        ...
                        <div class="col-md-4 income_per_month" style="display: none;">
                            <div class="form-cont">
                                ...
                                <?php
                                    ...
                                    {
                                ?>
                                <a href="<?= base_url();?>admin_dashboard/uploads/latest_itr/<?= $data1['latest_itr'];?>" target="_blank">VIEW PDF</a>
                                <?php
                                    }
                                    else
                                    {
                                ?>
                                <a href="<?= base_url();?>admin_dashboard/uploads/latest_itr/<?= $data1['latest_itr'];?>" class="fresco" data-fresco-group="example">
                                    <img src="<?= base_url();?>admin_dashboard/uploads/latest_itr/<?= $data1['latest_itr'];?>" class="img-responsive">
                                </a>
                                <?php
                                    }
                                ?>
                        ...
                        <div class="col-md-3">
                            <div class="form-cont">
                                ...
                                <?php
                                    ...
                                    {
                                ?>
                                <a href="<?= base_url();?>admin_dashboard/uploads/rc_upload_img/<?= $data1['rc_upload_img'];?>" target="_blank">VIEW PDF</a>
                                <?php
                                    }
                                    else
                                    {
                                ?>
                                <a href="<?= base_url();?>admin_dashboard/uploads/rc_upload_img/<?= $data1['rc_upload_img'];?>" class="fresco" data-fresco-group="example">
                                    <img src="<?= base_url();?>admin_dashboard/uploads/rc_upload_img/<?= $data1['rc_upload_img'];?>" class="img-responsive">
                                </a>
                                <?php
                                    }
                                ?>
                        ...
                        <div class="col-md-4">
                            <div class="form-cont">
                                ...
                                <?php
                                    ...
                                    {
                                ?>
                                <a href="<?= base_url();?>admin_dashboard/uploads/current_policy_img/<?= $data1['current_policy_img'];?>" target="_blank">VIEW PDF</a>
                                <?php
                                    }
                                    else
                                    {
                                ?>
                                <a href="<?= base_url();?>admin_dashboard/uploads/current_policy_img/<?= $data1['current_policy_img'];?>" class="fresco" data-fresco-group="example">
                                    <img src="<?= base_url();?>admin_dashboard/uploads/current_policy_img/<?= $data1['current_policy_img'];?>" class="img-responsive">
                                </a>
                                <?php
                                    }
                                ?>
                        ...
                        <div class="col-md-4">
                            <div class="form-cont">
                                ...
                                <?php
                                    ...
                                    {
                                ?>
                                <a href="<?= base_url();?>admin_dashboard/uploads/latest_card_statement_img/<?= $data1['latest_card_statement_img'];?>" target="_blank">VIEW PDF</a>
                                <?php
                                    }
                                    else
                                    {
                                ?>
                                <a href="<?= base_url();?>admin_dashboard/uploads/latest_card_statement_img/<?= $data1['latest_card_statement_img'];?>" class="fresco" data-fresco-group="example">
                                    <img src="<?= base_url();?>admin_dashboard/uploads/latest_card_statement_img/<?= $data1['latest_card_statement_img'];?>" class="img-responsive">
                                </a>
