...
if(isset($_POST['addcourses']))
{
    ...
    if(mysqli_query($conn, "INSERT INTO `courses` (`name`, `metatitle`, `image`, `description`) VALUES ('$name', '$metatitle', '$p_image1', '$description')"))
	
	{
		echo "<script language='javascript'>alert('Successfully Submited !');window.location = 'courses-list.php';</script>";
