...
if(isset($_POST['addgallery']))
{
    ...
    if(mysqli_query($conn, "INSERT INTO `gallery` (`name`, `metatitle`, `image`, `description`) VALUES ('$name', '$metatitle', '$p_image1', '$description')"))
	
	{
		echo "<script language='javascript'>alert('Successfully Submited !');window.location = 'gallery-list.php';</script>";
