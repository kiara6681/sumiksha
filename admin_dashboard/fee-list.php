...
<!--                 <div class="ibox-title">
                    <a href="fee.php" class="btn btn-success"><i class="fa fa-plus"></i> add</a>
                </div> -->
                <div class="ibox-content">
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered table-hover dataTables-example" >
                            ...
                            <tbody>
                            <?php 
                                $sql_cmp = $conn->query("SELECT * from fee order by id asc");
                                    $count=1;
                                ...
                                <tr class="gradeX">
                                   ...
                                   <!-- <td><?php echo $data_cmp['name']; ?></td>
                                    <td><?php echo $data_cmp['metatitle']; ?></td>
                                     <td><img src="uploads/fee/<?php echo $data_cmp['image']; ?>" style="width:100px;height:70px;"></td> -->
                                    <td><?php echo $data_cmp['description']; ?></td>
                                    <td class="center">
                                        <a href="fee_edit.php?id=<?php echo $data_cmp['id']; ?>" class="btn btn-primary btn-circle">
