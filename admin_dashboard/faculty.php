...
if(isset($_POST['addfaculty']))
{
    ...
    if(mysqli_query($conn, "INSERT INTO `faculty` (`name`, `metatitle`, `image`, `description`) VALUES ('$name', '$metatitle', '$p_image1', '$description')"))
    
    {
        echo "<script language='javascript'>alert('Successfully Submited !');window.location = 'faculty-list.php';</script>";
