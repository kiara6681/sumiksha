...
if(isset($_POST['addfee']))
{
    ...
    if(mysqli_query($conn, "INSERT INTO `fee` (`name`, `metatitle`, `image`, `description`) VALUES ('$name', '$metatitle', '$p_image1', '$description')"))
    
    {
        echo "<script language='javascript'>alert('Successfully Submited !');window.location = 'fee-list.php';</script>";
