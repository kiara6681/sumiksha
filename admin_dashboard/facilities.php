...
if(isset($_POST['addfacilities']))
{
    ...
    if(mysqli_query($conn, "INSERT INTO `facilities` (`name`, `metatitle`, `image`, `description`) VALUES ('$name', '$metatitle', '$p_image1', '$description')"))
    
    {
        echo "<script language='javascript'>alert('Successfully Submited !');window.location = 'facilities-list.php';</script>";
