...
<?php 
    ...
    if(isset($_REQUEST['delete']))
    {
        ...
        $delete = "delete from news_events where id='$id'";
                ...
                <div class="ibox-content">
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered table-hover dataTables-example" >
                            ...
                            <tbody>
                            <?php 
                                $sql_cmp = $conn->query("select * from news_events");
                                $count=1;
                            ...
                            ?>
                                <tr class="gradeX">
                                    ...
                                    <td><?php echo $data_cmp['owner']; ?></td>
                                    <td><img src="uploads/news_events/<?php echo $data_cmp['image']; ?>" style="width:100px;height:70px;"></td> 
                                    <td><?php echo $data_cmp['description']; ?></td>
                                    <td><?php echo $data_cmp['start_date']; ?></td>
                                    <td class="center">
                                        <a href="news_events_edit.php?id=<?php echo $data_cmp['id']; ?>" class="btn btn-primary btn-circle">
