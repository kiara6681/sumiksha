...
<script language="javascript"> 
    ...
    $(document).ready(function(e){
        ...
        // QD Form
        var qualification = "<?= $data1['qualification']?>";
        $("input[name='qualification'][value='"+qualification+"']").prop("checked", true);         

        var mailing_address = "<?= $data1['mailing_address']?>";
        $("input[name='mailing_address'][value='"+mailing_address+"']").prop("checked", true); 
    });
</script>
<style>
                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="tabs-container">
                        <ul class="nav nav-tabs" role="tablist">
                            <?php
                                if($data1['qb_format']==1):
                            ?>
                            <li class="active"><a class="nav-link active" data-toggle="tab" href="#tab-1"> QD Form</a></li>
                            <?php
                                else:
                            ?>
                            <li><a class="nav-link active" data-toggle="tab" href="#tab-2">Apply form</a></li>
                            <?php
                                endif;
                            ?>
                        </ul>
                        <div class="tab-content">
                            ...
                            <div role="tabpanel" id="tab-1" class="tab-pane active">
                                <div class="panel-body">
                                    <form id="qdform" class="job-form" action="" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-cont">
                                                    ...
                                                    ?>
                                                    <input name="full_name" type="text" class="validate[required] form-control" value="<?= $data1['full_name'];?>" readonly>
                                                </div>
                                            </div>
                                            <?php
                                                if($course_id==55):
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-cont">
                                                    ...
                                                    <input name="middle_name" type="text" class="validate[required] form-control" value="<?= $data1['middle_name'];?>" readonly>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-cont">
                                                    ...
                                                    <input name="last_name" type="text" class="validate[required] form-control" value="<?= $data1['last_name'];?>" readonly>
                                                </div>
                                            </div>
                                            <?php
                                                endif;
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-cont">
                                                    ...
                                                    <input name="dob" type="date" class="validate[required] form-control" value="<?= $data1['dob'];?>" readonly>
                                                </div>
                                            </div>   
                                            <?php
                                                if($course_id==35):
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-cont">
                                                    ...
                                                    <input name="city" type="text" class="form-control validate[required]" value="<?= $data1['city'];?>" readonly>
                                                </div>
                                            </div>
                                            <?php
                                                endif;
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-cont">
                                                    ...
                                                    <input name="mobile_no" type="tel" class="validate[required,custom[phone],maxSize[12],minSize[10]] form-control" value="<?= $data1['mobile_no'];?>" readonly>
                                                </div>
                                            </div>      
                                            <div class="col-md-4">
                                                <div class="form-cont">
                                                    <label>Email Id <span style="color: red">*</span></label>
                                                    <input name="email_id" type="email" class="validate[required,custom[email]] form-control" value="<?= $data1['email_id'];?>" readonly>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-cont">
                                                    <label>Pan Card No. <span style="color: red">*</span></label>
                                                    <input name="pan_card_no" type="text" class="validate[required,maxSize[10],minSize[10] form-control" style="text-transform:uppercase" value="<?= $data1['pan_card_no'];?>" readonly>
                                                </div>
                                            </div>
                                            <?php
                                                if($course_id==55):
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-cont">
                                                    ...
                                                    <input name="aadhar_card_no" type="text" class="form-control validate[required,maxSize[12],minSize[12]" value="<?= $data1['aadhar_card_no'];?>" readonly>
                                                </div>
                                            </div>   
                                            <div class="col-md-4">
                                                <div class="form-cont">
                                                    <label>Company Name <span style="color: red">*</span></label>
                                                    <input name="company_name" type="text" class="form-control validate[required]" value="<?= $data1['company_name'];?>" readonly>
                                                </div>
                                            </div> 
                                            <?php
                                                endif;
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-cont">
                                                    ...
                                                    <input name="father_name" type="text" class="validate[required] form-control" value="<?= $data1['father_name'];?>" readonly>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-cont">
                                                    ...
                                                    <input name="mother_name" type="text" class="validate[required] form-control" value="<?= $data1['mother_name'];?>" readonly>
                                                </div>
                                            </div>
                                            <?php
                                                if($course_id==35):
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-cont">
                                                    ...
                                                    ?>
                                                    <input name="residence_address" type="text" class="form-control validate[required]" value="<?= $data1['residence_address'];?>" readonly>
                                                </div>
                                            </div>
                                            <?php
                                                if($course_id==55):
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-cont">
                                                    ...
                                                    <input name="pincode" type="number" class="validate[required,,custom[onlyNumberSp],maxSize[6],minSize[6] form-control" value="<?= $data1['pincode'];?>" readonly>
                                                </div>
                                            </div>
                                            <?php
                                                endif;
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-cont">
                                                    ...
                                                    <input name="propriter" type="text" class="validate[required] form-control" value="<?= $data1['propriter'];?>" readonly>
                                                </div>
                                            </div> 
                                            <?php
                                                endif;
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-cont">
                                                    ...
                                                    <input name="office_address" type="text" class="form-control validate[required]" value="<?= $data1['office_address'];?>" readonly>
                                                </div>
                                            </div>
                                            <?php
                                                if($course_id==55):
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-cont">
                                                    ...
                                                    <input name="office_phone" type="tel" class="form-control validate[required,custom[phone],maxSize[12],minSize[10]]" value="<?= $data1['office_phone'];?>" readonly>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-cont">
                                                    ...
                                                    <input name="landmark" type="text" class="form-control validate[required]" value="<?= $data1['landmark'];?>" readonly>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-cont">
                                                    ...
                                                    <input name="alternate_card_no" type="text" class="form-control validate[required]" value="<?= $data1['alternate_card_no'];?>" readonly>
                                                </div>
                                            </div>
                                            <?php
                                                endif;
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-cont">
                                                    ...
                                                    <input name="designation" type="text" class="form-control validate[required]" value="<?= $data1['designation'];?>" readonly>
                                                </div>
                                            </div>
                                            <?php
                                                if($course_id==35):
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-cont">
                                                    ...
                                                    <input name="current_employment" type="text" class="form-control validate[required]" value="<?= $data1['current_employment'];?>" readonly>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-cont">
                                                    ...
                                                    <input name="work_experience" type="text" class="form-control validate[required]" value="<?= $data1['work_experience'];?>" readonly>
                                                </div>
                                            </div>
