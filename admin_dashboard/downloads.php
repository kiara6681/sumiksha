...
if(isset($_POST['adddownloads']))
{
    ...
    if ($_FILES['p_image1']['type'] != "application/pdf" && $_FILES['p_image1']['type'] != "image/jpeg" 
    ...
    if(mysqli_query($conn, "INSERT INTO `downloads` (`name`, `metatitle`, `image`, `description`) VALUES ('$name', '$metatitle', '$p_image1', '$description')"))
    
    {
        echo "<script language='javascript'>alert('Successfully Submited !');window.location = 'downloads-list.php';</script>";
