                ...
                <div class="ibox-content">
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered table-hover dataTables-example" >
                            ...
                            <tbody>
                            <?php 
                                $sql_cmp = $conn->query("select redem_statement_request.*, login.name as user_name from redem_statement_request left join login on login.id = redem_statement_request.user_id where redem_statement_request.name ='statement' order by redem_statement_request.id desc");
                                $count=1;
