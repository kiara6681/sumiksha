...
if(isset($_POST['addadmission']))
{
    ...
    if(mysqli_query($conn, "INSERT INTO `admission` (`name`, `metatitle`, `image`, `description`) VALUES ('$name', '$metatitle', '$p_image1', '$description')"))
    
    {
        echo "<script language='javascript'>alert('Successfully Submited !');window.location = 'admission-list.php';</script>";
